---
title: "Método Denver (ESDM): o que é e para quem"
excerpt: "ESDM em linguagem simples: idade, como são as sessões, diferença da ABA clássica e como começar a intervenção precoce."
...
# Método Denver (ESDM): o que é e para quem
...
O Early Start Denver Model (ESDM) é uma das abordagens de intervenção precoce mais estudadas para autismo entre ~1 e 5 anos. Diferente de modelos só de mesa, une ABA, brincadeira natural e vínculo, com a família no centro.

### Trilha relacionada

- [ABA para pais: como funciona](/blog/aba-para-pais)
- [TEACCH no autismo](/blog/como-funciona-o-teacch-tratamento-e-educacao-para-autistas)
- [DIR Floortime](/blog/o-que-e-dir-floortime)
