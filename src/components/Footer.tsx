        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/lojinha" className="text-white/80 hover:text-white transition-colors">
                  Lojinha
                </Link>
              </li>
              <li>
                <Link href="/apoie" className="text-white/80 hover:text-white transition-colors">
                  Apoie
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-blue-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <Link href="/metodologia-editorial" className="text-white/80 hover:text-white transition-colors text-sm">
